...
const (
	HelloService_Echo_FullMethodName = "/deliver.market.v1.HelloService/Echo"
)
...
func (c *helloServiceClient) Echo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Hello, error) {
...
func (UnimplementedHelloServiceServer) Echo(context.Context, *emptypb.Empty) (*Hello, error) {
...
func _HelloService_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServiceServer).Echo(ctx, req.(*emptypb.Empty))
	}
...
var HelloService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "deliver.market.v1.HelloService",
